...
// Formulário Feed Cleiton Querobin (idêntico ao Bio, planilha diferente)
export const feedCleitonQuerobinFormConfig: FormConfig = {
  id: 'feed-cleiton-querobin',
  title: 'Mentoria Biologia - Feed Cleiton Querobin',
  description: 'Aplicação para Mentoria de Biologia com Cleiton Querobin',
  videoUrl: 'https://www.youtube.com/embed/7tpz1cFcYQI',
  steps: [
    {
...
export const formConfigs: Record<string, FormConfig> = {
  bio: bioFormConfig,
  'feed-cleiton-querobin': feedCleitonQuerobinFormConfig,
};
