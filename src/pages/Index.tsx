  ...
  const renderStep = () => {
    ...
    if (step === 1) {
      return (
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-[16px] md:text-2xl font-normal md:font-bold text-white mb-4">Qual é o seu nome completo?</h2>
            <input
              type="text"
              value={formData.nome}
    ...
    if (step === 2) {
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-[16px] md:text-2xl font-normal md:font-bold text-white mb-2">Qual é o seu telefone?</h2>
    ...
    if (step === 3) {
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-[16px] md:text-2xl font-normal md:font-bold text-white mb-4">Qual é o seu e-mail?</h2>
            <input
              type="email"
    ...
    if (step === 4) {
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-[16px] md:text-2xl font-normal md:font-bold text-white mb-4">Qual é o seu Instagram?</h2>
            <div className="flex gap-2">
              <div className="flex items-center px-3 md:px-4 py-3 md:py-4 text-base md:text-lg rounded-lg bg-form-input-bg border border-form-input-border text-white">
                @
              </div>
    ...
    if (step === 5) {
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-[16px] md:text-2xl font-normal md:font-bold text-white mb-4">Qual é o seu nicho de atuação?</h2>
            <input
              type="text"
    ...
    if (step === 6) {
      ...
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-[16px] md:text-2xl font-normal md:font-bold text-white mb-6">Qual é o seu cargo na empresa?</h2>
